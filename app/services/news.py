...
class NewsService:
    ...
    async def list_with_filters(
        ...
        if params.category:
            stmt = stmt.where(NewsEnrichment.categories.contains([params.category]))
        ...
        if params.tag:
            ...
            count_stmt = count_stmt.where(NewsEnrichment.tags.contains([params.tag]))
    ...
    async def update_enrichment(
        ...
        enrichment_fields = {
            attr.key for attr in NewsEnrichment.__mapper__.column_attrs
        }
